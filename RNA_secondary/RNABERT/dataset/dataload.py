...
n = input('Please specify the dataset code (n) : ')

with open(f'./batches/train_{n}.json') as f: # Specify input directory
    rnas = json.load(f)
...
print('Samples excluded:',count)
print('X:',X_train.shape,'y:', y_train.shape)
print('Saving..')

np.savez_compressed(f'./training_{n}.npz', x=X_train, y=y_train) # Specify input directory
