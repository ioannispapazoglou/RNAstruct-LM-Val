...
with open('./dataset/allforrnabert.json') as f: # Select input directory
    rnas = json.load(f)
...
np.savez_compressed(f'rnabert_sec_probability{th}.npz', p=probability)
...
def heatdouble(heat,th):
    ...
    plt.savefig(f'rnabert_sec-{th}.pdf', format='pdf')
